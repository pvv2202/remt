...
# inputparser.add_argument('-o', type=str, default="def", required=False, help='File output name (HTML)')
    ...
    for rec in records:
        ...
        for feature in cds_features:
            if len(feature.domain_features) > 0:
                contig_id = rec.id
                print(feature.feature.qualifiers['domainator_All_REBASE_Gold_Standards_Protein_20221213'][0]) # This si the same as domain_desc
